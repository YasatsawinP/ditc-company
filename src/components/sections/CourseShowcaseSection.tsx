        ...
        <div className="flex flex-col mb-[15px] lg:mb-12 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex justify-end mb-6 lg:mb-0 lg:pb-3">
            <select
              ...
              className="border border-border rounded-soft bg-background text-foreground text-[12px] lg:text-[14px] px-3 py-2 outline-none cursor-pointer focus:border-primary"
            >
              {FILTER_TABS.map((tab) => (
